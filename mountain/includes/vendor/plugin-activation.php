    ...
    class TGM_Plugin_Activation {
        ...
        public function install_plugins_page() {
            ...
            <div class="tgmpa wrap">
                <h2><?php __esc_html( get_admin_page_title() ); ?></h2>
                ...
                <form id="tgmpa-plugins" action="" method="post">
                    <input type="hidden" name="tgmpa-page" value="<?php __esc_attr( $this->menu ); ?>" />
                    <input type="hidden" name="plugin_status" value="<?php __esc_attr( $plugin_table->view_context ); ?>" />
